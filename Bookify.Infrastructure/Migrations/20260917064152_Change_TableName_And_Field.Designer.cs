...
namespace Bookify.Infrastructure.Migrations
{
    ...
    [Migration("20260917064152_Change_TableName_And_Field")]
    partial class Change_TableName_And_Field
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Bookify.Domain.Apartments.Apartment", b =>
                {
                    ...
                    b.OwnsOne("Bookify.Domain.Commons.Money", "CleaningFeeAmount", b1 =>
                        {
                            b1.Property<Guid>("ApartmentId")
                                .HasColumnType("uuid")
                                .HasColumnName("id");
                    ...
                    b.OwnsOne("Bookify.Domain.Commons.Money", "Price", b1 =>
                        {
                            b1.Property<Guid>("ApartmentId")
                                .HasColumnType("uuid")
                                .HasColumnName("id");
            ...
            modelBuilder.Entity("Bookify.Domain.Bookings.Booking", b =>
                {
                    ...
                    b.OwnsOne("Bookify.Domain.Commons.Money", "AmenitiesUpChange", b1 =>
                        {
                    ...
                    b.OwnsOne("Bookify.Domain.Commons.Money", "CleaningFee", b1 =>
                        {
                            b1.Property<Guid>("BookingId")
                                .HasColumnType("uuid")
                                .HasColumnName("id");
                    ...
                    b.OwnsOne("Bookify.Domain.Commons.Money", "PriceForPeriod", b1 =>
                        {
                            b1.Property<Guid>("BookingId")
                                .HasColumnType("uuid")
                                .HasColumnName("id");
                    ...
                    b.OwnsOne("Bookify.Domain.Commons.Money", "TotalPrice", b1 =>
                        {
                            b1.Property<Guid>("BookingId")
                                .HasColumnType("uuid")
                                .HasColumnName("id");
